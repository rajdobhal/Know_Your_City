...
<!-- BEGIN LOGO -->
<a id="headerlink" href="#" title="home"><img id="logo" src="images/logo.png"  /><span id="sitename">Tourism</span></a>
<!-- END LOGO -->
...
<!-- Menu Item 1 -->
	<li class="current"><a href="index.html" title="Home"><span>Home</span></a>
    <ul>
    	<li><a href="index.html" title="Home"><span>Dark Version</span></a></li>
        <li><a href="Light/index.html" title="Home"><span>Light Version</span></a></li>
    </ul>
    </li>
<!-- Menu Item 2 -->
    <!--<li>
...
<!-- Menu Item 4 -->
    <li>
    	<!--<a href="autoComplete.php" title="Hotels"><span>Hotels</span></a>
        <ul>
...
<!-- Menu Item 5 -->
    <li><a href="autoComplete.php" title="Hotels"><span>Hotels</span></a></li>
	<li><a href="chart/examples/pie-legend/index.php" title="Hotels"><span>Crime Rate</span></a></li>
	<!-- Menu Item 6 -->
...
xmlhttp.open("GET","pro.php?q="+str,true);
xmlhttp.send();
}
...
$().ready(function() {
	$("#q").autocomplete("autoCompleteMain.php", {
		width: 150,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
...
<div id="content">
	<form autocomplete="off" action="pro.php">
		<p>
			Enter Hotel Name <label >:</label>
			<input type="text" CType="alpha" name="q" id="q"  onchange="dispp(this.value)" onpaste="this.onchange();" oninput="this.onchange();"/>
		</p>
		<input type="submit" value="Submit" />
	</form>


<!--	<div id="p">Customer info will be listed here...</div>-->
</div>
</body>
</html>
