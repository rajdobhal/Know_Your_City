   ...
   <header id="nav-bar" class="container">
      <div class="row">
         <div class="span12">
			...
			<?php
			     session_start();
				 echo $myInputName=$_SESSION['state'];
            ?>
			   <a type="submit" id="backbutton" class="win-backbutton" href="index1.php"></a>
               <!--<h5>Hotels</h5>-->
			</form>
   ...
   <div class="container">
      <div class="row">
         <div class="span12">
			...
			<div align="center" style="opacity:0.7;border-radius:30px;border:10px solid #ffffff;background-color:#ffffff;width=500px">
...
//$sql=mysql_query("INSERT INTO prefer(myInputName) VALUES ('$s')") ;
 ...
 //var_dump($s);
$data=mysql_query("SELECT DISTINCT DISTRICT FROM hotelinfo WHERE STATE='$s'");
