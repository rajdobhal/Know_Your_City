...
<form method="post" action="#try" class="form contact-form">
								<fieldset>
									<h2 align="center">Feedback form</h2>
									<div id="message"></div>
<div class="formRow">
										<div align="center" class="textField"><input type="text" name="name" id="name" placeholder="Your Name ..." required="true"/></div>
									</div>
									<div class="formRow">
										<div align="center" class="textField"><input type="email" name="email" id="email" placeholder="Your Email ..." required="true"/></div>
									</div>
									<div class="formRow">
										<div align="center" class="textField"><textarea cols="20" name="comment" id="comment" rows="4" placeholder="Your Comment ..." required="true"></textarea></div>
									</div>
									<p align="center"><input type="submit" value="submit" /></p>
									<!--<button value="submit" type="button"  onclick="alert('Thanks for feedback')">Submit</button>-->
